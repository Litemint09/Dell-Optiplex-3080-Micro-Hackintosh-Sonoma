# Dell-Optiplex-3080-Micro-Hackintosh-Sonoma

<img src="https://img.youtube.com/vi/1LBdjuBQVI4/maxresdefault.jpg" style="max-width: 100%;">
...
<tr>
<td>Processor</td>
<td>2.3 GHz Intel Core i5 6-Core (10th Gen)</td>
</tr>
<tr>
...
<tr>
<td>Memory</td>
<td>16GB of 2666 MHz DDR4 RAM</td>
</tr>
<tr>
<td>Storage</td>
<td>Samsung 240 Nvme Sata</td>
</tr>

<tr>
<td>Wireless Card</td>
<td>Intel AX210 Dual Band + Bluetooth</td>
</tr>
<tr>
<td>Bootloader</td>
<td>OpenCore</td>
...
<kbd><br>S O N O M A 14
<br><br>
<kbd> <img src="https://i.imgur.com/cpCjgaI.png" style="max-width: 100%;"></a></kbd></kbd>
<br><br>
</p><p align="center" dir="auto">
<kbd><br>About this Mac
<br><br>
<kbd><img src="https://i.imgur.com/w2eznDD.png" style="max-width: 100%;"></a></kbd></kbd>
</p>
<p align="center" dir="auto">
<kbd><br>Graphics Info
<br><br>
<kbd> <img src="https://i.imgur.com/Ta6F9gW.png" style="max-width: 100%;"></a></kbd></kbd>
</p>



<h1 tabindex="-1" dir="auto"><a id="user-content-bios" class="anchor" aria-hidden="true" tabindex="-1" href="#bios"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a>Bios Settings: Load the default settings</h1>
<ul dir="auto">

<li><code>Follow the Guide -&gt; </code>: <strong><a href="https://www.youtube.com/watch?v=1LBdjuBQVI4" rel="nofollow">Here</strong></a></li>

</ul>

<h2 tabindex="-1" dir="auto"><a id="user-content-whats-working" class="anchor" aria-hidden="true" tabindex="-1" href="#whats-working"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a>What's Working?</h2>
<ul dir="auto">
<li>QE/CI Intel HD Graphics 630</li>
<li>Power Management</li>
<li>Sleep, Shutdown, Restart </li>
<li>Audio Speaker &amp; Earphone </li>
<li>Wifi, Ethernet, bluetooth</li>
</ul>
...
<p dir="auto">Help Fix Screen Sleep, run these commands on your terminal</p>
...
sudo pmset tcpkeepalive 0</pre><div class="zeroclipboard-container">
    <clipboard-copy aria-label="Copy" class="ClipboardButton btn btn-invisible js-clipboard-copy m-2 p-0 tooltipped-no-delay d-flex flex-justify-center flex-items-center" data-copy-feedback="Copied!" data-tooltip-direction="w" value="sudo pmset autopoweroff 0
sudo pmset powernap 0
sudo pmset standby 0
sudo pmset proximitywake 0
sudo pmset tcpkeepalive 0" tabindex="0" role="button">
